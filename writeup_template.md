...
My model consists of a convolution neural network with 5 convolutional layers with filter sizes ranging from 32x32 to 5x5, followed by four fully connected layers. 
...
The data is normalized in the model using a Keras lambda layer (code line XX). 
...
The model was tested by running it through the simulator and ensuring that the vehicle could stay on the track 1 with speed 9.
